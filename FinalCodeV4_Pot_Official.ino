...
void loop() {
  ...
  }
  {
    ...
    {
      if (potTrack >= 0 && potTrack <= 42)
      {
        pot = false;
        //Serial.println(potRead);
      }
      else if (potTrack > 42 && potTrack <= 85)
      {
        autoMan = false;
        t = 0;
        pot = true;
      ...
      else if (potTrack > 85 && potTrack <= 127)
      {
        autoMan = false;
        t = 0;
        pot = true;
      ...
      else if (potTrack > 127 && potTrack <= 170)
      {
        autoMan = false;
        t = 0;
        pot = true;
      ...
      else if (potTrack > 170 && potTrack <= 212)
      {
        autoMan = false;
        t = 0;
        pot = true;
      ...
      else if (potTrack > 212 && potTrack <= 255)
      {
        autoMan = true;
        pot = false;
        t = 0;
